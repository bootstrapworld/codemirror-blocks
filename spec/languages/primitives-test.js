import {
  Primitive,
  PrimitiveGroup,
} from "codemirror-blocks/parsers/primitives";
...
describe("The primitives module", function () {
  ...
  describe("The PrimitiveGroup Class's", function () {
    beforeEach(function () {
      this.group = PrimitiveGroup.fromConfig("my-lang", {
        name: "root",
        primitives: [
          "add",
          "subtract",
    ...
    describe("fromConfig static method", function () {
      ...
      it("should still work if no primitives are given", function () {
        expect(() =>
          PrimitiveGroup.fromConfig({}, { name: "foo" })
        ).not.toThrow();
      });

      it("should throw an error if a config isn't understood", function () {
        expect(() =>
          PrimitiveGroup.fromConfig({}, { name: "foo", primitives: [1] })
        ).toThrow();
      });
    });
