...
import type { ASTNode, AST, Pos, NodeRef } from "../ast";
...
export function findAdjacentDropTargetId(child: NodeRef, onLeft: boolean) {
  ...
  const parentEl = child.parent?.node.element;
  if (!parentEl) {
    return null;
  }
